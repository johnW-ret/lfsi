...
module Display =
    ...
    let png (bytes: byte[]) =
        display Png (Convert.ToBase64String bytes)

    let pngBase64 (value: string) =
    ...
    module private Extensions =
        ...
        let private onLoadAsyncName =
            "Microsoft.DotNet.Interactive.IKernelExtension.OnLoadAsync"
