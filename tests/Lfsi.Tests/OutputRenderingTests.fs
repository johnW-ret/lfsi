    ...
    let tests =
        testList
            ...
            [ testCase "sixel encoder emits a visible local-palette image"
              ...
              testCase "chrome renderer captures a nonblank chart-sized element"
              <| fun _ ->
                  ...
                  | Some chrome ->
                      ...
                      let html =
                          """<div class="plotly-graph-div" style="width:640px;height:360px;background:#181818">
                      ...
                      | HtmlFrame frame ->
                          ...
                          | Some sixel ->
                              Expect.stringContains
                                  sixel
                                  ";2;100;0;0"
                                  "Chrome PNG remains visibly red after Sixel backend decoding" ]
